...
namespace ClickServ.Controllers
{
    public class ColaboradorController : Controller
    {
        ...
        public ColaboradorController(ClickServContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ColaboradorID,Nome,Funcao")] Colaborador colaborador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ColaboradorID,Nome,Funcao")] Colaborador colaborador)
        {
        ...
        {
            return _context.Colaboradors.Any(e => e.ColaboradorID == id);
        }
    }
}
